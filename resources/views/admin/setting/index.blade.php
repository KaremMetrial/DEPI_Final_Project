                                    ...
                                    <div class="card-body border">
                                        <form action="{{ route('admin.general-setting.update') }}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="site_name" id="" class="form-control" value="{{ config('settings.site_name') }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="">
                                                    Default Currency
                                                </label>
                                                <select class="select2 form-control" name="site_default_currency" id="">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="site_currency_icon" id="" class="form-control" value="{{ config('settings.site_currency_icon') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2 form-control" name="site_currency_icon_position" id="">
