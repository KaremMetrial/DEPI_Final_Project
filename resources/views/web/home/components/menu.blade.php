...
<section class="fp__menu mt_95 xs_mt_65">
    <div class="container">
        <div class="row wow fadeInUp" data-wow-duration="1s">
            <div class="col-md-8 col-lg-7 col-xl-6 m-auto text-center">
                <div class="fp__section_heading mb_45">
                    ...
                    <span>
                            <img src="{{ asset('web/images/heading_shapes.png') }}" alt="shapes"
        ...
        <div class="row grid">
            @foreach($categories as $category)
                @php
                    $products = \App\Models\Product::where(['show_at_home' => 1, 'status' => 1, 'categories_id' => $category->id])
                                    ->orderBy('id', 'DESC')
                                    ->take(8)
                                    ->get();
                @endphp
                @foreach($products as $product)
                    ...
                    <div class="col-xl-3 col-sm-6 col-lg-4  {{ $category->slug }}" data-wow-duration="1s">
